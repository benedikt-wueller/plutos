<template>
  <div class="fixed top-0 bottom-0 left-0 right-0" style="background-color: rgba(0, 0, 0, 0.5)" @mousedown.self="hide">
    <div class="container mx-auto py-4 px-4 grid content-center h-full" @mousedown.self="hide">
