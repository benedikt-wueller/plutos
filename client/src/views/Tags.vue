<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
      ...
      <card name="Apply Patterns" icon="fa-solid fa-arrows-rotate" class="bg-blue-100 hover:bg-blue-200 cursor-pointer" @click="applyCategories">
        <div class="mt-2">
          Determine the category for all transactions based on the category patterns defined. This will override
...
export default {
  ...
  methods: {
    ...
    applyCategories() {
      this.$store.dispatch('applyCategories')
    }
  }
}
</script>
